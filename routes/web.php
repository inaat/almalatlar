...
Route::get('/welcome', function () {
    ...
    return view('welcomeEnglish', compact('slides', 'categories', 'services', 'aboutTabs', 'partners'));
});
Route::get('/welcome-ar', function () {
    ...
    $aboutTabs   = \App\Models\AboutTab::orderBy('sort_order')->get();
    $partners    = \App\Models\Partner::where('is_active', true)->orderBy('sort_order')->get();
    return view('welcomeArabic', compact('slides', 'categories', 'services', 'aboutTabs', 'partners'));
});
