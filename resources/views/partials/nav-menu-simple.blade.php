...
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-9013"><a href="/"><span>{{ $isAr ? 'الصفحة الرئيسية' : 'Home' }}</span></a></li>
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-9014"><a href="/about"><span>{{ $isAr ? 'نبذة عنا' : 'About' }}</span></a>
<ul class="sub-menu">
	@foreach($navAboutPages as $navAboutPage)
	<li class="menu-item menu-item-type-post_type menu-item-object-page"><a href="/about/{{ $navAboutPage->slug }}"><span>{{ $isAr && $navAboutPage->title_ar ? $navAboutPage->title_ar : $navAboutPage->title }}</span></a></li>
	@endforeach
</ul>
</li>
...
<li class="menu-item menu-item-type-custom menu-item-object-custom megamenu megamenu-style-alt menu-item-has-children menu-item-9195"><a href="#"><span>{{ $isAr ? 'الخدمات' : 'Services' }}</span></a><ul class="sub-menu"><li><div class="container">		<div data-elementor-type="wp-post" data-elementor-id="9051" class="elementor elementor-9051">
...
<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-9016"><a href="#"><span>{{ $isAr ? 'المنتجات' : 'Products' }}</span></a>
<ul class="sub-menu">
	@foreach($navProducts as $navProduct)
	<li class="menu-item menu-item-type-post_type menu-item-object-page"><a href="/product/{{ $navProduct->slug }}"><span>{{ $isAr && $navProduct->name_ar ? $navProduct->name_ar : $navProduct->name }}</span></a></li>
	@endforeach
</ul>
</li>
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9635"><a href="/contact"><span>{{ $isAr ? 'تواصل معنا' : 'Contact' }}</span></a></li>
