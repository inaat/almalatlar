...
@php $lang = $lang ?? 'en'; @endphp
    <header id="ct-header-elementor" class="is-sticky">
        ...
        <div class="menu-header-menu-container"><ul id="menu-header-menu" class="ct-main-menu clearfix"><li id="menu-item-9013" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-2392 current_page_item menu-item-9013"><a href="index.html" aria-current="page"><span class="ct-menu-item"><span class="ct-item--number"><span></span></span>{{ $lang === 'ar' ? 'الصفحة الرئيسية' : 'Home' }}</span><span class="ct-menu--plus"></span><span class="ct-menu--line"></span></a></li>
<li id="menu-item-9014" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-9014"><a href="about/index.html"><span class="ct-menu-item"><span class="ct-item--number"><span></span></span>{{ $lang === 'ar' ? 'نبذة عنا' : 'About' }}</span><span class="ct-menu--plus"></span><span class="ct-menu--line"></span></a>
<ul class="sub-menu">
	<li id="menu-item-9419" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9419"><a href="customers-clients/index.html"><span class="ct-menu-item"><span class="ct-item--number"><span></span></span>{{ $lang === 'ar' ? 'العملاء والمستهلكين' : 'Customers/Clients' }}</span><span class="ct-menu--plus"></span><span class="ct-menu--line"></span></a></li>
	<li id="menu-item-9418" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9418"><a href="partners/index.html"><span class="ct-menu-item"><span class="ct-item--number"><span></span></span>{{ $lang === 'ar' ? 'الشركاء' : 'Our Partners' }}</span><span class="ct-menu--plus"></span><span class="ct-menu--line"></span></a></li>
</ul>
</li>
<li id="menu-item-9195" class="menu-item menu-item-type-custom menu-item-object-custom megamenu megamenu-style-alt menu-item-has-children menu-item-9195"><a href="#"><span class="ct-menu-item"><span class="ct-item--number"><span></span></span>{{ $lang === 'ar' ? 'المعلومات' : 'Services' }}</span><span class="ct-menu--plus"></span><span class="ct-menu--line"></span></a><ul class="sub-menu"><li><div class="container">		<div data-elementor-type="wp-post" data-elementor-id="9051" class="elementor elementor-9051">
  ...
  <div class="ct-heading--inner">
    <div class="ct-inline-css"  data-css="
        ...
        <span class="ct-text-inner">{{ $lang === 'ar' ? 'حلول تكنولوجيا المعلومات المتكاملة' : 'IT Generated Solutions' }}</span>    </h3>
  </div>
</div>
			</div>
			</div>
			...
			<div class="elementor-widget-container">
                    ...
                    <a href="service/it-infrastructure-management/index.html">
                                                    <i aria-hidden="true" class="far fa-dot-circle"></i>                                                                            {{ $lang === 'ar' ? 'إدارة البنية التحتية' : 'IT Infrastructure Management' }}                                            </a>
                </li>
                        <li>
                    <a href="service/it-information-security/index.html">
                                                    <i aria-hidden="true" class="far fa-dot-circle"></i>                                                                            {{ $lang === 'ar' ? 'الأمن المعلوماتي لتكنولوجيا المعلومات' : 'IT Information Security' }}                                            </a>
                </li>
                        <li>
                    <a href="service/it-managed-services/index.html">
                                                    <i aria-hidden="true" class="far fa-dot-circle"></i>                                                                            {{ $lang === 'ar' ? 'خدمات تكنولوجيا المعلومات المدارة' : 'IT Managed Services' }}                                            </a>
                </li>
                        <li>
                    <a href="service/data-center-solutions-services/index.html">
                                                    <i aria-hidden="true" class="far fa-dot-circle"></i>                                                                            {{ $lang === 'ar' ? 'خدمات حلول مراكز البيانات' : 'Data Center Solutions Services' }}                                            </a>
                </li>
                        <li>
                    <a href="service/applications-development-services/index.html">
                                                    <i aria-hidden="true" class="far fa-dot-circle"></i>                                                                            {{ $lang === 'ar' ? 'خدمات تطوير التطبيقات' : 'Applications Development Services' }}                                            </a>
                </li>
                        <li>
                    <a href="service/it-service-management/index.html">
                                                    <i aria-hidden="true" class="far fa-dot-circle"></i>                                                                            {{ $lang === 'ar' ? 'إدارة خدمات تكنولوجيا المعلومات' : 'IT Service Management' }}                                            </a>
                </li>
                        <li>
                    <a href="service/voice-over-ip-telephony-solutions-voip/index.html">
                                                    <i aria-hidden="true" class="far fa-dot-circle"></i>                                                                            {{ $lang === 'ar' ? 'حلول الاتصال الهاتفي عبر بروتوكول الإنترنت (الفويب)' : 'Voice Over IP Telephony Solutions ( VOIP )' }}                                            </a>
                </li>
                        <li>
                    <a href="service/wireless-solutions/index.html">
                                                    <i aria-hidden="true" class="far fa-dot-circle"></i>                                                                            {{ $lang === 'ar' ? 'الحلول اللاسلكية' : 'Wireless Solutions' }}                                            </a>
                </li>
            </ul>
			</div>
			</div>
  ...
  <div class="ct-heading--inner">
    <div class="ct-inline-css"  data-css="
	    ...
	    <h3 class="item--title st-default " data-wow-delay="ms">
        <span class="ct-text-inner">{{ $lang === 'ar' ? 'حلول وخدمات  الجيل الثاني لتكن لوجيا المعلومات' : 'Next Generation IT Services' }}</span>    </h3>
  </div>
</div>
			</div>
			</div>
			...
			<div class="elementor-widget-container">
                    ...
                    <a href="service/next-generation-data-centers/index.html">
                                                    <i aria-hidden="true" class="far fa-dot-circle"></i>                                                                            {{ $lang === 'ar' ? 'مراكز بيانات الجيل التالي' : 'Next Generation  Data Centers' }}                                            </a>
                </li>
                        <li>
                    <a href="service/artificial-intelligence-ai/index.html">
                                                    <i aria-hidden="true" class="far fa-dot-circle"></i>                                                                            {{ $lang === 'ar' ? 'الذكاء الاصطناعي' : 'Artificial Intelligence ( AI )' }}                                            </a>
                </li>
                        <li>
                    <a href="service/internet-of-things-iot/index.html">
                                                    <i aria-hidden="true" class="far fa-dot-circle"></i>                                                                            {{ $lang === 'ar' ? 'إنترنت الأشياء (IOT))' : 'Internet Of Things ( IOT )' }}                                            </a>
                </li>
                        <li>
                    <a href="service/big-data/index.html">
                                                    <i aria-hidden="true" class="far fa-dot-circle"></i>                                                                            {{ $lang === 'ar' ? 'البيانات الضخمة' : 'Big Data' }}                                            </a>
                </li>
            </ul>
			</div>
			</div>
  ...
  <div class="ct-heading--inner">
    <div class="ct-inline-css"  data-css="
	    ...
	    <h3 class="item--title st-default " data-wow-delay="ms">
        <span class="ct-text-inner">{{ $lang === 'ar' ? 'تقديم خدمات الاستشارات  والحلول' : 'Consulting Services' }}</span>    </h3>
  </div>
</div>
			</div>
			</div>
			...
			<div class="elementor-widget-container">
                    ...
                    <a href="service/business-process-automation/index.html">
                                                    <i aria-hidden="true" class="far fa-dot-circle"></i>                                                                            {{ $lang === 'ar' ? 'أتمتة العمليات التجارية' : 'Business Process Automation' }}                                            </a>
                </li>
                        <li>
                    <a href="service/it-resource-outsourcing/index.html">
                                                    <i aria-hidden="true" class="far fa-dot-circle"></i>                                                                            {{ $lang === 'ar' ? 'تعهيد موارد تكنولوجيا المعلومات' : 'IT Resource Outsourcing' }}                                            </a>
                </li>
                        <li>
                    <a href="service/call-center-services/index.html">
                                                    <i aria-hidden="true" class="far fa-dot-circle"></i>                                                                            {{ $lang === 'ar' ? 'خدمات مركز الاتصال' : 'Call Center Services' }}                                            </a>
                </li>
            </ul>
			</div>
			</div>
  ...
  <div class="ct-heading--inner">
    <div class="ct-inline-css"  data-css="
	    ...
	    <h3 class="item--title st-default " data-wow-delay="ms">
        <span class="ct-text-inner">{{ $lang === 'ar' ? 'خدمات التيار المنخفض' : 'Low Curent Services' }}</span>    </h3>
  </div>
</div>
			</div>
			</div>
			...
			<div class="elementor-widget-container">
                    ...
                    <a href="service/cctv-system/index.html">
                                                    <i aria-hidden="true" class="far fa-dot-circle"></i>                                                                            {{ $lang === 'ar' ? 'نظام كاميرات المراقبة' : 'CCTV System' }}                                            </a>
                </li>
                        <li>
                    <a href="service/access-control-system/index.html">
                                                    <i aria-hidden="true" class="far fa-dot-circle"></i>                                                                            {{ $lang === 'ar' ? 'نظام مراقبة الوصول' : 'Access Control System' }}                                            </a>
                </li>
                        <li>
                    <a href="service/fire-alarm-fire-suspension-system/index.html">
                                                    <i aria-hidden="true" class="far fa-dot-circle"></i>                                                                            {{ $lang === 'ar' ? 'نظام إنذار وإطفاء الحرائق' : 'Fire Alarm & Fire Suspension System' }}                                            </a>
                </li>
                        <li>
                    <a href="service/public-address-system/index.html">
                                                    <i aria-hidden="true" class="far fa-dot-circle"></i>                                                                            {{ $lang === 'ar' ? 'نظام مخاطبة الجمهور (الإذاعة الداخلية)' : 'Public Address System' }}                                            </a>
                </li>
                        <li>
                    <a href="service/audio-visual-system/index.html">
                                                    <i aria-hidden="true" class="far fa-dot-circle"></i>                                                                            {{ $lang === 'ar' ? 'النظام السمعى البصرى' : 'Audio & Visual System' }}                                            </a>
                </li>
                        <li>
                    <a href="service/building-management-system/index.html">
                                                    <i aria-hidden="true" class="far fa-dot-circle"></i>                                                                            {{ $lang === 'ar' ? 'نظام ادارة المباني' : 'Building Management System' }}                                            </a>
                </li>
                        <li>
                    <a href="service/master-clock-system/index.html">
                                                    <i aria-hidden="true" class="far fa-dot-circle"></i>                                                                            {{ $lang === 'ar' ? 'نظام الساعة المركزية' : 'Master Clock System' }}                                            </a>
                </li>
            </ul>
			</div>
			</div>
...
<li id="menu-item-9016" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-9016"><a href="#"><span class="ct-menu-item"><span class="ct-item--number"><span></span></span>{{ $lang === 'ar' ? 'المنتجات' : 'Products' }}</span><span class="ct-menu--plus"></span><span class="ct-menu--line"></span></a>
<ul class="sub-menu">
	<li id="menu-item-9382" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9382"><a href="it-hardware-software/index.html"><span class="ct-menu-item"><span class="ct-item--number"><span></span></span>{{ $lang === 'ar' ? 'أجهزة وبرمجيات تكنولوجيا المعلومات' : 'IT Hardware &#038; Software' }}</span><span class="ct-menu--plus"></span><span class="ct-menu--line"></span></a></li>
	<li id="menu-item-9395" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9395"><a href="it-passive-equipment/index.html"><span class="ct-menu-item"><span class="ct-item--number"><span></span></span>{{ $lang === 'ar' ? 'معدات تكنولوجيا المعلومات الخاملة' : 'IT Passive Equipment' }}</span><span class="ct-menu--plus"></span><span class="ct-menu--line"></span></a></li>
</ul>
</li>
<li id="menu-item-9635" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9635"><a href="contact/index.html"><span class="ct-menu-item"><span class="ct-item--number"><span></span></span>{{ $lang === 'ar' ? 'تواصل  معنا' : 'Contact' }}</span><span class="ct-menu--plus"></span><span class="ct-menu--line"></span></a></li>
</ul></div>    </div>
			</div>
			</div>
...
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-9014"><a href="about/index.html"><span class="ct-menu-item"><span class="ct-item--number"><span></span></span>{{ $lang === 'ar' ? 'نبذة عنا' : 'About' }}</span><span class="ct-menu--plus"></span><span class="ct-menu--line"></span></a>
<ul class="sub-menu">
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9419"><a href="customers-clients/index.html"><span class="ct-menu-item"><span class="ct-item--number"><span></span></span>{{ $lang === 'ar' ? 'العملاء والمستهلكين' : 'Customers/Clients' }}</span><span class="ct-menu--plus"></span><span class="ct-menu--line"></span></a></li>
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9418"><a href="partners/index.html"><span class="ct-menu-item"><span class="ct-item--number"><span></span></span>{{ $lang === 'ar' ? 'الشركاء' : 'Our Partners' }}</span><span class="ct-menu--plus"></span><span class="ct-menu--line"></span></a></li>
</ul>
</li>
...
<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-9016"><a href="#"><span class="ct-menu-item"><span class="ct-item--number"><span></span></span>{{ $lang === 'ar' ? 'المنتجات' : 'Products' }}</span><span class="ct-menu--plus"></span><span class="ct-menu--line"></span></a>
<ul class="sub-menu">
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9382"><a href="it-hardware-software/index.html"><span class="ct-menu-item"><span class="ct-item--number"><span></span></span>{{ $lang === 'ar' ? 'أجهزة وبرمجيات تكنولوجيا المعلومات' : 'IT Hardware &#038; Software' }}</span><span class="ct-menu--plus"></span><span class="ct-menu--line"></span></a></li>
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9395"><a href="it-passive-equipment/index.html"><span class="ct-menu-item"><span class="ct-item--number"><span></span></span>{{ $lang === 'ar' ? 'معدات تكنولوجيا المعلومات الخاملة' : 'IT Passive Equipment' }}</span><span class="ct-menu--plus"></span><span class="ct-menu--line"></span></a></li>
</ul>
</li>
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9635"><a href="contact/index.html"><span class="ct-menu-item"><span class="ct-item--number"><span></span></span>{{ $lang === 'ar' ? 'تواصل  معنا' : 'Contact' }}</span><span class="ct-menu--plus"></span><span class="ct-menu--line"></span></a></li>
</ul></div>    </div>
			</div>
			</div>
                    ...
                    <div class="ct-header-navigation">
                        <nav class="ct-main-navigation">
                            <div class="ct-main-navigation-inner">
                                        ...
                                        <a class="logo-mobile" href="index.html" title="MAC |" rel="home"><img src="wp-content/uploads/2021/11/web-logo.png" alt="MAC |"/></a><a class="logo-light" href="index.html" title="MAC |" rel="home"><img src="wp-content/themes/itfirm/assets/images/logo-df.png" alt="MAC |"/></a>                                    </div>
                                                                                                <ul id="menu-header-menu-2" class="ct-main-menu clearfix"><li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-2392 current_page_item menu-item-9013"><a href="index.html" aria-current="page"><span>{{ $lang === 'ar' ? 'الصفحة الرئيسية' : 'Home' }}</span></a></li>
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-9014"><a href="about/index.html"><span>{{ $lang === 'ar' ? 'نبذة عنا' : 'About' }}</span></a>
<ul class="sub-menu">
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9419"><a href="customers-clients/index.html"><span>{{ $lang === 'ar' ? 'العملاء والمستهلكين' : 'Customers/Clients' }}</span></a></li>
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9418"><a href="partners/index.html"><span>{{ $lang === 'ar' ? 'الشركاء' : 'Our Partners' }}</span></a></li>
</ul>
@if($lang === 'ar')<span class="ct-menu-toggle caseicon-angle-arrow-down"></span>@endif</li>
<li class="menu-item menu-item-type-custom menu-item-object-custom megamenu megamenu-style-alt menu-item-has-children menu-item-9195"><a href="#"><span>{{ $lang === 'ar' ? 'المعلومات' : 'Services' }}</span></a><ul class="sub-menu"><li><div class="container">		<div data-elementor-type="wp-post" data-elementor-id="9051" class="elementor elementor-9051">
			        <section class="elementor-section elementor-top-section elementor-element elementor-element-ceec42a elementor-section-boxed elementor-section-height-default elementor-section-height-default ct-header-fixed-none ct-column-none ct-row-scroll-none ct-row-gradient--none" data-id="ceec42a" data-element_type="section" data-e-type="section">
  ...
  <div class="ct-heading--inner">
	...
	</div></li></ul>@if($lang === 'ar')<span class="ct-menu-toggle caseicon-angle-arrow-down"></span>@endif</li>
<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-9016"><a href="#"><span>{{ $lang === 'ar' ? 'المنتجات' : 'Products' }}</span></a>
<ul class="sub-menu">
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9382"><a href="it-hardware-software/index.html"><span>{{ $lang === 'ar' ? 'أجهزة وبرمجيات تكنولوجيا المعلومات' : 'IT Hardware &#038; Software' }}</span></a></li>
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9395"><a href="it-passive-equipment/index.html"><span>{{ $lang === 'ar' ? 'معدات تكنولوجيا المعلومات الخاملة' : 'IT Passive Equipment' }}</span></a></li>
</ul>
@if($lang === 'ar')<span class="ct-menu-toggle caseicon-angle-arrow-down"></span>@endif</li>
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9635"><a href="contact/index.html"><span>{{ $lang === 'ar' ? 'تواصل  معنا' : 'Contact' }}</span></a></li>
</ul>                            </div>
                        </nav>
                    </div>
